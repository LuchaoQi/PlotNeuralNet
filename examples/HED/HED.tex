...
\pic[shift={(1,0,0)}] at (p2-east) {RightBandedBox={name=cr3,%
        xlabel={{"1"}},zlabel=6,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=1,width={1},depth=43, caption = Fully Connected Layer}};


\pic[shift={(1.5,0,0)}] at (cr3-east) {Ball={name=elt2,%
...
\pic[shift={(\poolsep,0,0)}] at (cr3-east) {Box={name=p3,%
        fill=\PoolColor,opacity=0.5,height=14,width=1,depth=14, caption = MaxPooling1D}};
