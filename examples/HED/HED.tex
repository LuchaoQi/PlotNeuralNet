...
\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=cr1,%
        xlabel={{"1","1"}},zlabel=1440,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=40,width={1},depth=144, caption = Conv1D}};
\pic[shift={(\poolsep,0,0)}] at (cr1-east) {Box={name=p1,%
        fill=\PoolColor,opacity=0.5,height=30,width=1,depth=30, caption = MaxPooling1D}};
% conv2_1,conv2_2,pool2
\pic[shift={(1,0,0)}] at (p1-east) {RightBandedBox={name=cr2,%
        xlabel={{"10","10"}},zlabel=719,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=30,width={10},depth=71, caption = Conv1D}};
\pic[shift={(\poolsep,0,0)}] at (cr2-east) {Box={name=p2,%
        fill=\PoolColor,opacity=0.5,height=23,width=1,depth=23, caption = MaxPooling1D}};

% flatten
\pic[shift={(1,0,0)}] at (p2-east) {RightBandedBox={name=cr3,%
        xlabel={{"6"}},zlabel=359,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=23,width={6},depth=35, caption = Flatten Layer}};
% dense
\pic[shift={(\poolsep,0,0)}] at (cr3-east) {Box={name=p3,%
        fill=\PoolColor,opacity=0.5,height=14,width=1,depth=215, caption = Dense Layer}};

%\pic[shift={(1.5,0,0)}] at (p3-east) {Ball={name=elt2,%
...
%% fc8 -> cr8 (score32)
%\pic[shift={(0,0,0)}] at (p3-east) {Box={name=score16,%
...
%\pic[shift={(2.5,0,0)}] at (p3-east) {Ball={name=d2,%
%        fill=\SumColor,opacity=0.6,%
%        radius=2.5,logo=$+$}};  
\pic[shift={(2.5,0,0)}] at (p3-east) {Box={name=d2,%
        xlabel={{"","dummy"}},fill=\DcnvColor,opacity=0.7,height=14,width=0.5,depth=9, caption = Concatenated Layer}};
%% Dcnv8    
...
%% Dcnv envelope    
%\pic[shift={(-0.2,0,0)}] at (d2-west) {Box={name=env,caption=concatenation of deconvolved feature maps,%
...
\pic[shift={(0.3,0,22+\skipshift)}] at (p2-east) {Box={name=score,%
        xlabel={{"1","dummy"}},fill=\ConvColor,height=14,width=1,depth=3,zlabel=3, caption = Covariates Layer}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Final convolution

\pic[shift={(3,0,0)}] at (d2-east) {Box={name=output,%
        xlabel={{"1","dummy"}},fill=\ConvColor,height=14,width=1,depth=40,zlabel, caption = Regression Layer}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Draw connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\draw [connection]  (p3-east)    -- node {\midarrow} (d2-west);
%
